...
(use-feature org
  ...
  (setq org-capture-templates
        (quote (("t" "TODO    (t)" entry (file "~/Sync/org/refile.org")
                ...
                ("r" "Research")
                ("rp" "Research project" entry (file "~/Sync/org/inbox.org")
	         "* TODO %^{Project title} :research::%^G:\n:PROPERTIES:\n:CREATED: %U\n:END:\n%^{Project description}\n** TODO Literature review\n** TODO %?\n** TODO Summary\n** TODO Reports\n** Ideas\n" :clock-in t :clock-resume t)
                ...
                ("b" "Link from browser" entry (file "~/Sync/org/inbox.org")
	         "* TODO %? |- (%:description) :BOOKMARK:\n:PROPERTIES:\n:CREATED: %U\n:Source: %:link\n:END:\n%i\n" :clock-in t :clock-resume t)
             	("s" "Selection from browser" entry (file "~/Sync/org/inbox.org")
	         "* TODO %? :BOOKMARK:\n%(replace-regexp-in-string \"\n.*\" \"\" \"%i\")\n:PROPERTIES:\n:CREATED: %U\n:Source: %:link\n:END:\n%i\n" :clock-in t :clock-resume t)
                                        ;("j" "Journal" entry (file+olp+datetree "~/Sync/org/diary.org")
                                        ; "**** %U \n %? \n %a \n" :clock-in t :clock-resume t :tree-type week)
                ("j" "Journal" entry (function nanounanue/org-journal-find-location)
                 "* %(format-time-string org-journal-time-format)%^{Title}\n%i%?")
                ("c" "Contactos") ;; Tomado de https://joshrollinswrites.com/help-desk-head-desk/sub-menus-in-org/
                ("ca" "Amistades"  entry
                 (file+headline "~/Sync/org/contactos.org" "Amistades") nanounanue/org-contacts-template :empty-lines 1 :clock-in t)
                ("ct" "Trabajo" entry
                 (file+headline "~/Sync/org/contactos.org" "Trabajo")
                 nanounanue/org-contacts-template :empty-lines 1 :clock-in t)
                ("cf" "Familia" entry
                 (file+headline "~/Sync/org/contactos.org" "Familia") nanounanue/org-contacts-template :empty-lines 1 :clock-in t)
