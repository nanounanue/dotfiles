...
(use-package projectile
  :demand t
  :preface
  (defun nanounanue/projectile-compilation-buffers (&optional project)
...
#+begin_quote
This package is easiest way to open particular link on github/gitlab/bitbucket/stash/git.savannah.gnu.org/sourcehut from Emacs
#+end_quote
